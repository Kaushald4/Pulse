  ...
  const groups: Array<{ label: string; entries: NavEntry[] }> = [
    {
      ...
      entries: [
        ...
        },
        {
          ...
          icon: Inbox,
          count: stats.inbox,
          active: view === "feed" && filters.state === "inbox",
          onClick: () => goToFeed({ state: "inbox" }),
        },
        {
          key: "saved",
          label: "Reading queue",
          icon: Bookmark,
          count: stats.saved,
          active: view === "feed" && filters.state === "saved",
          onClick: () => goToFeed({ state: "saved" }),
        },
        {
          key: "important",
          label: "Important",
          ...
          active: view === "feed" && filters.state === "important",
          onClick: () => goToFeed({ state: "important" }),
        },
        {
          key: "archived",
          label: "Archive",
          ...
          active: view === "feed" && filters.state === "archived",
          onClick: () => goToFeed({ state: "archived" }),
        },
      ],
    },
    {
    ...
    },
    {
      ...
      entries: [
        ...
        },
        {
          ...
          icon: GitBranch,
          count: stats.repos,
          active: view === "feed" && filters.category === "repo",
          onClick: () => goToFeed({ category: "repo" }),
        },
        {
          key: "paper",
          label: "Papers",
          icon: FileText,
          count: stats.papers,
          active: view === "feed" && filters.category === "paper",
          onClick: () => goToFeed({ category: "paper" }),
        },
        {
          key: "resource",
          label: "Products & Docs",
          ...
          active: view === "feed" && filters.category === "resource",
          onClick: () => goToFeed({ category: "resource" }),
        },
        {
          key: "news",
          label: "Discussions",
          icon: Radio,
          count: stats.news,
          active: view === "feed" && filters.category === "news",
          onClick: () => goToFeed({ category: "news" }),
        },
      ],
    },
  ];
